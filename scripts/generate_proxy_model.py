...
def generate_gravity_apdl(layout, angle_deg, bolt_xy, work_dir):
    ...
    lines.append("")
    lines.append("! ── Mesh: clean mapped mesh (no hardpoints) ──")
    ...
    lines.append("")
    lines.append("! ── BC: NSEL near each bolt, then D (all DOF=0 for zero-height gravity) ──")
